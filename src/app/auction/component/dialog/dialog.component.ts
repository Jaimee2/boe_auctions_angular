...
@Component({
  ...
  template: `
    <div class="p-4 bg-white rounded-lg shadow-lg max-w-md mx-auto">
      <h1 class="text-xl font-bold text-gray-800 mb-3">Auction Details</h1>

      <div class="mb-3">
        <h2 class="text-lg font-semibold text-gray-700">Auction Information</h2>
      ...
      <div class="mb-3">
        <h2 class="text-lg font-semibold text-gray-700">Asset Information</h2>
      ...
      <div class="mt-4 text-center">
        <button
          (click)="goToAssetPage()"
          class="px-3 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700">
          Go to Asset Page
        </button>
      </div>
    </div>

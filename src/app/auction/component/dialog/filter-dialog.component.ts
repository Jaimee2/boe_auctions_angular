...
@Component({
  ...
  template: `
    <div class="m-6 space-y-2">
      ...
      <div class="p-2 m-2">
        <label for="UserEmail" class="block font-medium text-gray-700 text-center"> Province </label>
        <input
          type="email"
          id="UserEmail"
          ...
          <ul class="space-y-1 border-t border-gray-200 p-4">
            <li>
              <label class="inline-flex items-center gap-2" for="FilterInStock">
                ...
                <span class="text-sm font-medium text-gray-700"> Garaje (5+) </span>
              </label>
            </li>
            ...
            <li>
              <label class="inline-flex items-center gap-2" for="FilterPreOrder">
                ...
                <span class="text-sm font-medium text-gray-700"> Vivienda (3+) </span>
              </label>
            </li>
            ...
            <li>
              <label class="inline-flex items-center gap-2" for="FilterOutOfStock">
                ...
                <span class="text-sm font-medium text-gray-700"> Local Comercial (10+) </span>
              </label>
            </li>
            ...
            <li>
              <label class="inline-flex items-center gap-2" for="FilterOutOfStock">
                ...
                <span class="text-sm font-medium text-gray-700"> Nave Industrial (10+) </span>
              </label>
            </li>
